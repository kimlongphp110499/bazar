    ...
    <body>
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="{{URL::to('/create-vnpay')}}" id="create_form" method="post">       
                    @csrf
                   
                     <input type="hidden" name="Ma_hd" value="{{$order->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="order_id" name="order_id" type="text" value="{{$order->id}}" readonly/>
                    </div>
                    <div class="form-group">
                        <label for="amount">Số tiền</label>
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="{{$order->price}}" readonly/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        $startTime = date("YmdHis"); @endphp
                        <input class="form-control" id="txtexpire"
                               name="txtexpire" type="text" value="<?php echo date('YmdHis',strtotime('+15 minutes',strtotime($startTime))) ?>"/>
                    </div>
